...
export const he: Record<TranslationKey, string> = {
  ...
  'summary.accountValue': 'שווי החשבון',
  'summary.sinceStart': 'מאז ההתחלה',
  'summary.cash': 'מזומן {amount}',
  'summary.openCount_one': 'פוזיציה פתוחה אחת',
  'summary.openCount_other': '{count} פוזיציות פתוחות',
  'summary.showDetails': 'פירוט',
  'summary.hideDetails': 'הסתרת הפירוט',
  'summary.openPortfolio': 'לתיק',
  'tm.title': 'מכונת הזמן',
  'tm.subtitle': 'גרף אמיתי מהעבר, בלי שם ובלי תאריכים. קבלו החלטה, ואז צפו במה שקרה.',
  'tm.mystery': 'נכס מסתורי',
  'tm.mysteryHint': 'מוצגים {bars} ימי מסחר. {horizon} הבאים מוסתרים.',
  'tm.loading': 'חוזרים בזמן…',
  'tm.error': 'לא הצלחנו לטעון גרף מהעבר.',
  'tm.axisStart': 'עכשיו',
  'tm.levelUp': 'רמה עליונה',
  'tm.levelDown': 'רמה תחתונה',
  'tm.levelsNote': 'ריבוע התשע, {degrees}° מכל צד של הסגירה האחרונה.',
  'tm.question': 'לאיזו רמה המחיר יגיע קודם ב-{horizon} ימי המסחר הבאים?',
  'tm.callUp': 'קודם לעליונה',
  'tm.callDown': 'קודם לתחתונה',
  'tm.callNeither': 'לאף אחת',
  'tm.confidenceQuestion': 'כמה אתם בטוחים?',
  'tm.conf50': 'הטלת מטבע',
  'tm.conf65': 'נוטים',
  'tm.conf80': 'די בטוחים',
  'tm.conf95': 'בטוחים לגמרי',
  'tm.stakes': 'אם צדקתם: {win} נקודות. אם טעיתם: {lose}.',
  'tm.play': 'הריצו קדימה',
  'tm.playing': 'מריצים את ימי המסחר המוסתרים…',
  'tm.skip': 'דלגו לסוף',
  'tm.right': 'צדקתם',
  'tm.wrong': 'לא הפעם',
  'tm.outcomeUp': 'המחיר הגיע לרמה העליונה ב-{price} אחרי {sessions}.',
  'tm.outcomeDown': 'המחיר הגיע לרמה התחתונה ב-{price} אחרי {sessions}.',
  'tm.outcomeNeither': 'אף רמה לא הושגה ב-{horizon} ימי מסחר.',
  'tm.sessions_one': 'יום מסחר אחד',
  'tm.sessions_other': '{count} ימי מסחר',
  'tm.revealedHint': '{horizon} ימי המסחר המוסתרים, עכשיו גלויים.',
  'tm.reveal': 'זה היה {ticker}, ב-{date}.',
  'tm.lessonConfidentRight': 'צדקתם, וגם אמרתם את זה. השילוב הזה הוא מה שמזכה בנקודות.',
  'tm.lessonModestRight': 'צדקתם, בצניעות. אם החלטות כאלה ימשיכו להצליח, תוכלו להרשות לעצמכם לומר שאתם בטוחים יותר.',
  'tm.lessonConfidentWrong': 'החטאה בביטחון היא היקרה מכולן. רמות גאן הן גאומטריה, לא הבטחה, והשווקים מתעלמים מהן לא מעט.',
  'tm.lessonModestWrong': 'החטאה זולה: לא הייתם בטוחים, והניקוד משקף את זה.',
  'tm.next': 'לסיבוב הבא',
  'tm.openToday': 'ל-{ticker} היום',
  'tm.score': 'ניקוד',
  'tm.rounds': 'סיבובים',
  'tm.streak': 'רצף',
  'tm.bestStreak': 'שיא',
  'tm.calibrationTitle': 'כשאמרתם, זה קרה?',
  'tm.calibrationKey': 'הפס הוא כמה פעמים ההחלטות שלכם התממשו. הקו הוא כמה אמרתם שאתם בטוחים.',
  'tm.roundsCount_one': 'סיבוב אחד',
  'tm.roundsCount_other': '{count} סיבובים',
  'tm.verdictEarly': 'שחקו {min} סיבובים באותה רמת ביטחון כדי לראות עד כמה היא תואמת את המציאות.',
  'tm.verdictCalibrated': 'מכוילים היטב עד כה: כמה שאתם אומרים שאתם בטוחים תואם את כמה שאתם צודקים.',
  'tm.verdictOver': 'ביטחון יתר ב„{step}”: צדקתם ב-{actual} מהפעמים, לא ב-{claimed}.',
  'tm.verdictUnder': 'ביטחון חסר ב„{step}”: צדקתם ב-{actual} מהפעמים, יותר מה-{claimed} שאמרתם.',
  'tm.howTitle': 'איך הניקוד עובד',
  'tm.howBody': 'ביטחון חותך לשני הכיוונים. הטלת מטבע לא מזכה ולא עולה כלום; „בטוחים לגמרי” מזכה ב-50+ כשצדקתם ועולה 130 כשטעיתם. לאורך הרבה סיבובים הניקוד הכי גבוה כשכמה שאתם אומרים שאתם בטוחים תואם את כמה שאתם באמת צודקים. זו המיומנות שהמשחק מאמן: לדעת כמה אתם יודעים.',
  'tm.ctaBody': 'החלטה עיוורת על גרף אמיתי מהעבר. כדקה לסיבוב.',
  'tm.ctaPlay': 'לשחק',
  'glossary.title': 'מילון מונחים',
  'glossary.subtitle': 'כל מילה שהאפליקציה משתמשת בה, בהסבר למי שמעולם לא סחר.',
  'glossary.search': 'חיפוש מונח…',
  'glossary.noResults': 'אין מונח שמתאים.',
  'glossary.related': 'ראו גם:',
  'glossary.back': 'חזרה',
  'glossary.count_one': 'מונח אחד',
  'glossary.count_other': '{count} מונחים',
  ...
  'markets.tabAlerts': 'התראות',
  'markets.tabStats': 'נתונים',
  'markets.holdingDot': '(מוחזק אצלכם)',
  ...
  'portfolio.tabCosts': 'עלויות',
  'portfolio.startingBalance': 'סכום התחלתי',
  ...
  'privacy.updated': 'עודכן לאחרונה ב־23 בספטמבר 2026.',
  'privacy.intro':
    '\u2066invest-pal\u2069 הוא כלי לימודי. הכסף בו דמיוני, וכך גם רוב מה שאפליקציה כזו הייתה רוצה לדעת עליכם בדרך כלל. הדף הזה מפרט מה באמת נשמר, למה, ומה לא נשמר בכלל.',
  'privacy.collectTitle': 'מה נשמר',
  'privacy.dataEmail': 'כתובת האימייל שלכם',
  'privacy.dataEmailWhy':
    'כדי שתוכלו להתחבר בחזרה ולהגיע לחשבון שלכם. היא לא מוצגת לאף אחד אחר.',
  'privacy.dataName': 'שם תצוגה, אם הזנתם',
  'privacy.dataNameWhy': 'משמש לברכה בלוח הבקרה. לא חובה.',
  'privacy.dataExperience': 'רמת הניסיון שבחרתם בהרשמה',
  'privacy.dataExperienceWhy':
    'קובעת כמה מנטור ה־AI מפרט. שום דבר אחר לא קורא אותה.',
  'privacy.dataTrades': 'העסקאות, הפוזיציות, הפקודות וההתראות הווירטואליות שלכם',
  'privacy.dataTradesWhy':
    'זה התיק עצמו — בלעדיו אין אפליקציה. הכול כסף דמיוני.',
  'privacy.dataPrefs': 'רשימת המעקב, השפה וגודל הטקסט',
  'privacy.dataPrefsWhy':
    'כדי שהאפליקציה תיראה אותו דבר בפעם הבאה. השפה וגודל הטקסט לא יוצאים מהדפדפן שלכם.',
  'privacy.dataGame': 'הסיבובים שלכם במכונת הזמן',
  'privacy.dataGameWhy': 'כדי להציג את הניקוד ועד כמה הביטחון שלכם תואם את התוצאות. נשמרים רק בדפדפן הזה ולא נשלחים לשום מקום.',
  'privacy.notCollectTitle': 'מה לא נשמר',
  'privacy.noTracking':
    'אין אנליטיקס, אין פיקסלי מעקב, אין פרופיל פרסומי או התנהגותי.',
  'privacy.noAds': 'אין רשתות פרסום, ואין צד שלישי שמקבל את הנתונים שלכם.',
  'privacy.noLocation': 'אין מיקום, אין מזהי מכשיר ואין אנשי קשר.',
  'privacy.noContacts': 'אין גישה לתמונות, לקבצים, למצלמה או למיקרופון.',
  'privacy.noPayments':
    'אין פרטי תשלום — אין על מה לשלם, ולא זז כסף אמיתי.',
  'privacy.noSelling': 'שום דבר לא נמכר ולא משותף. אין למי למכור.',
  'privacy.whereTitle': 'איפה זה נשמר',
  'privacy.whereBody':
    'בדאטהבייס של \u2066Supabase (PostgreSQL)\u2069, מוגן ב־\u2066row\u2011level\u00a0security\u2069 כך שחשבון אחד לא יכול לקרוא שורות של חשבון אחר. מחירי השוק נמשכים מ־\u2066Yahoo Finance\u2069 דרך פרוקסי שמעביר רק סימול — הזהות שלכם אינה חלק מהבקשה הזו.',
  'privacy.deleteTitle': 'מחיקת הנתונים שלכם',
  'privacy.deleteBody':
    '"התחלה מחדש" בדף תיק ההשקעות מוחקת מייד כל עסקה, פקודה והתראה בחשבון. למחיקת החשבון עצמו — שלחו מייל לכתובת שלמטה והוא יימחק יחד עם כל מה שמקושר אליו.',
  'privacy.contactTitle': 'יצירת קשר',
  'privacy.contactBody':
    'שאלות על המדיניות הזו, או בקשה למחוק את החשבון: {email}',
  'privacy.contactUnset':
    'לשאלות על המדיניות הזו, או לבקשה למחוק את החשבון — פנו לכתובת המפתח שמופיעה בדף האפליקציה בחנות.',
  'nav.menu': 'תפריט',
  'nav.openMenu': 'פתיחת התפריט',
  'nav.signedOut': 'לא מחוברים',
  'settings.title': 'הגדרות',
  'settings.appearance': 'מראה',
  'settings.modeSystem': 'אוטומטי',
  'settings.modeLight': 'בהיר',
  'settings.modeDark': 'כהה',
  'settings.palette': 'צבע',
  'settings.paletteNeutral': 'ניטרלי',
  'settings.paletteBlue': 'כחול',
  ...
  'settings.reduceMotionHint': 'מבטל החלקות והבהובים.',
