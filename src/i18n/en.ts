...
export const en = {
  ...
  'summary.accountValue': 'Account value',
  'summary.sinceStart': 'since you started',
  'summary.cash': 'Cash {amount}',
  'summary.openCount_one': '{count} open position',
  'summary.openCount_other': '{count} open positions',
  'summary.showDetails': 'Details',
  'summary.hideDetails': 'Hide details',
  'summary.openPortfolio': 'Portfolio',
  'tm.title': 'Time Machine',
  'tm.subtitle': 'A real chart from the past, with the name and dates hidden. Make the call, then watch what happened.',
  'tm.mystery': 'Mystery asset',
  'tm.mysteryHint': '{bars} sessions shown. The next {horizon} are hidden.',
  'tm.loading': 'Travelling back…',
  'tm.error': 'Could not load a chart from the past.',
  'tm.axisStart': 'now',
  'tm.levelUp': 'Up level',
  'tm.levelDown': 'Down level',
  'tm.levelsNote': 'Square of Nine, {degrees}° either side of the last close.',
  'tm.question': 'Which does price reach first in the next {horizon} sessions?',
  'tm.callUp': 'Up level first',
  'tm.callDown': 'Down level first',
  'tm.callNeither': 'Neither',
  'tm.confidenceQuestion': 'How sure are you?',
  'tm.conf50': 'Coin toss',
  'tm.conf65': 'Leaning',
  'tm.conf80': 'Confident',
  'tm.conf95': 'Certain',
  'tm.stakes': 'Right: {win} points. Wrong: {lose}.',
  'tm.play': 'Play it forward',
  'tm.playing': 'Playing the hidden sessions…',
  'tm.skip': 'Skip to the end',
  'tm.right': 'Right',
  'tm.wrong': 'Not this time',
  'tm.outcomeUp': 'Price reached the up level at {price} after {sessions}.',
  'tm.outcomeDown': 'Price reached the down level at {price} after {sessions}.',
  'tm.outcomeNeither': 'Neither level was reached in {horizon} sessions.',
  'tm.sessions_one': '{count} session',
  'tm.sessions_other': '{count} sessions',
  'tm.revealedHint': 'The {horizon} hidden sessions, now shown.',
  'tm.reveal': 'It was {ticker}, on {date}.',
  'tm.lessonConfidentRight': 'Right, and you said so. That combination is what scores.',
  'tm.lessonModestRight': 'Right, and modest about it. If calls like this keep landing, you can afford to say you are surer.',
  'tm.lessonConfidentWrong': 'A confident miss is the expensive kind. Gann levels are geometry, not a promise, and markets ignore them often.',
  'tm.lessonModestWrong': 'A cheap miss: you were not sure, and the score reflects that.',
  'tm.next': 'Next round',
  'tm.openToday': 'See {ticker} today',
  'tm.score': 'Score',
  'tm.rounds': 'Rounds',
  'tm.streak': 'Streak',
  'tm.bestStreak': 'Best',
  'tm.calibrationTitle': 'When you said it, did it happen?',
  'tm.calibrationKey': 'The bar is how often your calls came true. The tick is how sure you said you were.',
  'tm.roundsCount_one': '{count} round',
  'tm.roundsCount_other': '{count} rounds',
  'tm.verdictEarly': 'Play {min} rounds at one confidence level to see how well it matches reality.',
  'tm.verdictCalibrated': 'Well calibrated so far: how sure you say you are matches how often you are right.',
  'tm.verdictOver': 'Overconfident at “{step}”: right {actual} of the time, not {claimed}.',
  'tm.verdictUnder': 'Underconfident at “{step}”: right {actual} of the time, more than the {claimed} you claimed.',
  'tm.howTitle': 'How scoring works',
  'tm.howBody': 'Confidence cuts both ways. A coin toss scores nothing either way; “Certain” earns +50 when right and costs −130 when wrong. Over many rounds the score is highest when how sure you say you are matches how often you are actually right. That is the skill this trains: knowing how much you know.',
  'tm.ctaBody': 'A blind call on a real chart from the past. About a minute a round.',
  'tm.ctaPlay': 'Play',
  'glossary.title': 'Glossary',
  'glossary.subtitle': 'Every word this app uses, explained for someone who has never traded.',
  'glossary.search': 'Search terms…',
  'glossary.noResults': 'No term matches that.',
  'glossary.related': 'See also:',
  'glossary.back': 'Back',
  'glossary.count_one': '{count} term',
  'glossary.count_other': '{count} terms',
  ...
  'markets.tabAlerts': 'Alerts',
  'markets.tabStats': 'Stats',
  'markets.holdingDot': '(you hold this)',
  ...
  'portfolio.tabCosts': 'Costs',
  'portfolio.startingBalance': 'Started with',
  ...
  'privacy.updated': 'Last updated 23 September 2026.',
  'privacy.intro':
  ...
  'privacy.dataGame': 'Your Time Machine rounds',
  'privacy.dataGameWhy': 'To show your score and how well your confidence matches your results. Kept only in this browser and never sent anywhere.',
